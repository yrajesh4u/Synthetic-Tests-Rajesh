...
class TestBodyUpdateServiceScenario1:
    ...
    def test_101_ProvAccountStore(self):
        ...
        assert bool(re.search('optStatus', resp.text)), 'Not able to get optStatus in resp'
        assert resp_json['optStatus'] == 'optIn', 'Error: optStatus not found.'
        assert resp_json['type'] == 'provAccount', 'Error: provAccount not found.'
